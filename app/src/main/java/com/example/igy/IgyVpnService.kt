...
class IgyVpnService : VpnService(), Runnable {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        // Start Monitor Loop (Stats & Subscription)
        startMonitorLoop()
    ...
    override fun run() {
        try {
            ...
            // 2. Establish TUN (Always, for Local Bypass/Focus to work)
            val builder = Builder()
