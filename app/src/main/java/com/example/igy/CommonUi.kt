...
@Composable
fun MatrixTab(label: String, isActive: Boolean, isDarkMode: Boolean, modifier: Modifier, activeColor: Color = Color(0xFF2E8B57), onClick: () -> Unit) {
    ...
    Box(
        modifier = modifier
            .fillMaxHeight()
            .background(if (isActive) cardBg else Color.Transparent)
            .border(0.5.dp, wheat)
            .clickable { onClick() },
